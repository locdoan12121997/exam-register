...
modulesInfo.open('GET','http://localhost:8080/exam-register/rest/semesters/' + semesterId + '/modules',true);
    ...
    if (modulesInfo.status === 200){
      ...
      //create dynamic event
        function dynamicEvent(){
            document.location.href = "session.html" + "?semesterId=" + semesterId + "&moduleId=" +  this.className;
        }
        ...
        for (var i = 0; i < moduleObj.length; i++) {
            ...
            for (var j = 0; j < col.length; j++) {
                ...
                tabCell.className = moduleObj[i].id;
