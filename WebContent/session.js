...
console.log(moduleId + " " + semesterId);

sessionsInfo.open('GET','http://localhost:8080/exam-register/rest/modules/' + moduleId + '/sessions',true);
sessionsInfo.responseType = 'text';
sessionsInfo.send(null);
function toExam(){
	document.location.href = "exam_assistant.html" + "?semesterId=" + semesterId + "&moduleId=" + moduleId;
}
function toModule(){
